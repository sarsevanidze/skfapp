...
class Customers extends Model
{
    ...
    {
        return Orders::where('status', 'completed')->where('user_email', $this->user_email)->count('status');
    }

    public function getTotalRefundedOrdersAttribute()
    {
        return Orders::where('status', 'refunded')->where('user_email', $this->user_email)->count('status');
    }
